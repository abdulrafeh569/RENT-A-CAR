...
#include "ui_user_view_car.h"
#include <QFile>
#include <QTextStream>
#include <QMessageBox>
User_View_car::User_View_car(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::User_View_car)
{
    setWindowFlags(Qt::Window);
    ui->setupUi(this);
    ui->table->setColumnCount(4);
    QStringList headers = {"Name", "Company", "Model", "Price"};
...
void User_View_car::loadData()
{
    ...
    while (!in.atEnd())
    {
        ...
        {
            // Only add data if availability is "Yes"
            ...
            // Clear variables for the next car entry
            name.clear();
            company.clear();
            model.clear();
            price.clear();
