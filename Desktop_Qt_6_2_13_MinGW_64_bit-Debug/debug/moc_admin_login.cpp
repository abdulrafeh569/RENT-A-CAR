...
struct qt_meta_stringdata_Admin_Login_t {
    uint offsetsAndSizes[6];
    char stringdata0[30];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Admin_Login_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_Admin_Login_t qt_meta_stringdata_Admin_Login = {
    {
        QT_MOC_LITERAL(0, 11),  // "Admin_Login"
        QT_MOC_LITERAL(12, 16),  // "on_login_clicked"
        QT_MOC_LITERAL(29, 0)   // ""
    },
    "Admin_Login\0on_login_clicked\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Admin_Login[] = {
...
const QMetaObject Admin_Login::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Admin_Login.offsetsAndSizes,
    qt_meta_data_Admin_Login,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Admin_Login_t
...
void *Admin_Login::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Admin_Login.stringdata0))
